...
from app import forms as cforms
...
# from app import forms as pforms
...
def home(request, *args, **kwargs):
    ...
    try:
        flashsale = apmodels.FlashSale.objects.filter(end_date_time__gte=now(),start_date_time__lte =now())[0]
