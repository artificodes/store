...
class ProductVariation(models.Model):
    ...
    measurement_unit =models.CharField(default='', max_length=100,blank=False,choices=(('cm','CM'),('m','M'),('mm','MM'),('kg','KG'),('g','G'),('pounce','Pounce'),('sqm','SQM')))
...
class SavedProduct(models.Model):
    ...
    def save(self,*args,**kwargs):
        ...
        if self.saveid == '':
            ...
            self.saveid=TID[0:100]+'00'+str(SavedProduct.objects.all().count()+1)
