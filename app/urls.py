...
urlpatterns = [    
    ...
    path('home', apviews.home, name='customer_home'),
    ...
    path('flashsale/<str:id>', apviews.flashsalespage, name='customer_flash_sales_page'),
    ...
    path('slideshow/<str:slug>', apviews.slideshowpage, name='customer_slideshow_page'),
    ...
    path('add_variation_to_cart/<str:productid>', apviews.add_variation_to_cart, name='customer_add_variation_to_cart'),
    ...
    path('cart/', apviews.cart, name='customer_cart'),
