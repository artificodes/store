    ...
    // alert(spaObject['url'])
      if (response.login || response.signup){
        ...
        if (window.history.replaceState) {
          window.history.replaceState(window.location.hash, document.title,  '#/seller/login?next=' + nextUrl);
       }
        ...
        if (window.history.replaceState) {
          window.history.replaceState(window.location.hash, document.title,  '#/seller/signup?next=' + nextUrl);
       }
      }
      Main.swap('');
            document.title = response.title
